...
import {
  Text as FormLabel,
  Input as FormInput,
  Input as FormValidationMessage,
  Button,
  Divider,
  SocialIcon,
  Icon
      ...
      <KeyboardAwareScrollView enableOnAndroid={true}>
        ...
        <View>
          <View>
            ...
            />
            <View>{this.renderFormError("phone")}</View>
          </View>
          <View
          ...
          >
            <View style={{ flex: 1 }}>
              ...
              />
              <View>{this.renderFormError("firstname")}</View>
            </View>
            <View style={{ flex: 1 }}>
              ...
              />
              <View>{this.renderFormError("lastname")}</View>
            </View>
          </View>
          <View>
            ...
            />
            <View>{this.renderFormError("email")}</View>
          </View>
          <View>
            ...
            />
            <View>{this.renderFormError("password")}</View>
          </View>
